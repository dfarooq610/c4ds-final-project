  ...
  return (
    <Flickity>
        <figure>
            ...
            <p style={{textAlign: 'center'}}>Carlton Complex Fire behind a ridge, 2014. Photo courtesy of Danny Yanarella.</p>
        </figure>
        <figure>
        ...
        <figure>
            ...
            <p style={{textAlign: 'center'}}>Burned Home from Carlton Complex Wildfire, 2014. Photo courtesy of AdamCohn.</p>
        </figure>
        <figure>
            ...
            <p style={{textAlign: 'center'}}>Carlton Complex Fire, 2014. Photo courtesy of Washington State Department of Natural Resources.</p>
        </figure>
        <figure>
            ...
            <p style={{textAlign: 'center'}}>Carlton Complex mop up, 2014. Photo courtesy of Washington State Department of Natural Resources.</p>
        </figure>
    </Flickity>
  );
}
